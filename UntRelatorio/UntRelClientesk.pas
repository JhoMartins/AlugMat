...
type
  TFrmRelClientesk = class(TFrmPadraoRel)
...
var
  FrmRelClientesk: TFrmRelClientesk;

implementation

{$R *.dfm}

procedure TFrmRelClientesk.btn_imprimirClick(Sender: TObject);
var StrLiga: String;
begin
  StrLiga:= ' where ';
  FDQuery1.Close;
...
procedure TFrmRelClientesk.btn_limparClick(Sender: TObject);
begin
  inherited;
