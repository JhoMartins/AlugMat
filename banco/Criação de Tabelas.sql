...
INSERT INTO PRODUTO (DESCRICAO, CD_INTERNO, VALOR_DIARIA, STATUS, DISPONIVEL, CARACTERISTICAS, CD_MARCA, CD_CATEGORIA, CD_FORNECEDOR, DATA_INC, DATA_ALT, CD_CLIENTE) VALUES ('Espátula', 'E01', 5.00, 'S', 'S', 'Largura da lâmina: 102mm (4")', 1, 1, 2, CURRENT_TIMESTAMP, NULL, 3)
INSERT INTO PRODUTO (DESCRICAO, CD_INTERNO, VALOR_DIARIA, STATUS, DISPONIVEL, CARACTERISTICAS, CD_MARCA, CD_CATEGORIA, CD_FORNECEDOR, DATA_INC, DATA_ALT, CD_CLIENTE) VALUES ('Parafusadeira de impacto', 'GSB18VLI', 919.90, 'S', 'S', 'Bateria 18v - 1/2 pol', 2, 2, 3, CURRENT_TIMESTAMP, NULL, 3)
...
INSERT INTO PRODUTO (DESCRICAO, CD_INTERNO, VALOR_DIARIA, STATUS, DISPONIVEL, CARACTERISTICAS, CD_MARCA, CD_CATEGORIA, CD_FORNECEDOR, DATA_INC, DATA_ALT, CD_CLIENTE) VALUES ('Jogo de Bits e Soquetes com Chave Catraca', '68736', 35.00, 'S', 'S', '47 peças, inúmeras utilidades. Encaixe: 3/4"', 1, 1, 3, CURRENT_TIMESTAMP, NULL, 2)
