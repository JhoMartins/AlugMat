...
INSERT INTO USUARIO (STATUS, USU_NOME, USU_DEPARTAMENTO, USU_LOGIN, USU_SENHA, USU_ID_PERFIL) VALUES ('S','Cristiane Poletto', 'Desenvolvimento', 'chpoletto', '123456', 1);
...
INSERT INTO MARCA (DESCRICAO, DATA_INC, DATA_ALT, STATUS) VALUES ('3M', CURRENT_TIMESTAMP, NULL, 'S')
INSERT INTO MARCA (DESCRICAO, DATA_INC, DATA_ALT, STATUS) VALUES ('CAT', CURRENT_TIMESTAMP, NULL, 'S')
INSERT INTO MARCA (DESCRICAO, DATA_INC, DATA_ALT, STATUS) VALUES ('Philips', CURRENT_TIMESTAMP, NULL, 'S')
INSERT INTO MARCA (DESCRICAO, DATA_INC, DATA_ALT, STATUS) VALUES ('Fluke', CURRENT_TIMESTAMP, NULL, 'S')
...
INSERT INTO CATEGORIA (DESCRICAO, DATA_INC, DATA_ALT, STATUS) VALUES ('Eletrônica', CURRENT_TIMESTAMP, NULL, 'S')
INSERT INTO CATEGORIA (DESCRICAO, DATA_INC, DATA_ALT, STATUS) VALUES ('Construção', CURRENT_TIMESTAMP, NULL, 'S')
INSERT INTO CATEGORIA (DESCRICAO, DATA_INC, DATA_ALT, STATUS) VALUES ('Máquina', CURRENT_TIMESTAMP, NULL, 'S')
...
INSERT INTO PRODUTO (DESCRICAO, CD_INTERNO, VALOR_DIARIA, STATUS, DISPONIVEL, CARACTERISTICAS, CD_MARCA, CD_CATEGORIA, CD_FORNECEDOR, DATA_INC, DATA_ALT, CD_CLIENTE) VALUES ('Trator', 'TR01', 500.00, 'S', 'S', 'Trator Urbano com capacidade de movimentar até 500kg', 2, 3, 1, CURRENT_TIMESTAMP, NULL, NULL)
INSERT INTO PRODUTO (DESCRICAO, CD_INTERNO, VALOR_DIARIA, STATUS, DISPONIVEL, CARACTERISTICAS, CD_MARCA, CD_CATEGORIA, CD_FORNECEDOR, DATA_INC, DATA_ALT, CD_CLIENTE) VALUES ('Fita ultra potente', 'FT01', 8.00, 'S', 'S', 'Fita Adesiva super potente para colar objetos de até 50kg na parede', 1, 2, 2, CURRENT_TIMESTAMP, NULL, NULL)
INSERT INTO PRODUTO (DESCRICAO, CD_INTERNO, VALOR_DIARIA, STATUS, DISPONIVEL, CARACTERISTICAS, CD_MARCA, CD_CATEGORIA, CD_FORNECEDOR, DATA_INC, DATA_ALT, CD_CLIENTE) VALUES ('Multímetro', 'MT01', 9.10, 'S', 'S', 'Múltimetro, voltimetro, amperimetro entre outras funções', 4, 1, 3, CURRENT_TIMESTAMP, NULL, NULL)
INSERT INTO PRODUTO (DESCRICAO, CD_INTERNO, VALOR_DIARIA, STATUS, DISPONIVEL, CARACTERISTICAS, CD_MARCA, CD_CATEGORIA, CD_FORNECEDOR, DATA_INC, DATA_ALT, CD_CLIENTE) VALUES ('Guindaste', 'GD01', 700.00, 'S', 'S', 'Guindaste de 50m capacidade para erguer até 5T', 2, 3, 1, CURRENT_TIMESTAMP, NULL, NULL)
INSERT INTO PRODUTO (DESCRICAO, CD_INTERNO, VALOR_DIARIA, STATUS, DISPONIVEL, CARACTERISTICAS, CD_MARCA, CD_CATEGORIA, CD_FORNECEDOR, DATA_INC, DATA_ALT, CD_CLIENTE) VALUES ('Chave de Fenda', 'CH01', 1.50, 'S', 'S', 'Chave Philips de 10cm', 3, 1, 3, CURRENT_TIMESTAMP, NULL, NULL)
