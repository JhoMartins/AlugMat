...
INSERT INTO USUARIO (STATUS, USU_NOME, USU_DEPARTAMENTO, USU_LOGIN, USU_SENHA, USU_ID_PERFIL, DATA_INC) VALUES ('S','Jhonatan Martins', 'Desenvolvimento', 'jhbmartins', '123456', 1, CURRENT_TIMESTAMP);
INSERT INTO USUARIO (STATUS, USU_NOME, USU_DEPARTAMENTO, USU_LOGIN, USU_SENHA, USU_ID_PERFIL, DATA_INC) VALUES ('S','Cristiane Poletto', 'Desenvolvimento', 'cpoletto', '123', 1, CURRENT_TIMESTAMP);
INSERT INTO USUARIO (STATUS, USU_NOME, USU_DEPARTAMENTO, USU_LOGIN, USU_SENHA, USU_ID_PERFIL, DATA_INC) VALUES ('S','Deividson Sabino', 'Suporte', 'desabino', '123456', 1, CURRENT_TIMESTAMP);
INSERT INTO USUARIO (STATUS, USU_NOME, USU_DEPARTAMENTO, USU_LOGIN, USU_SENHA, USU_ID_PERFIL, DATA_INC) VALUES ('S','Felipe Noronha', 'Vendas', 'fenoronha', '1234', 2, CURRENT_TIMESTAMP);
INSERT INTO USUARIO (STATUS, USU_NOME, USU_DEPARTAMENTO, USU_LOGIN, USU_SENHA, USU_ID_PERFIL, DATA_INC) VALUES ('S','Francisco Bióca', 'Vendas', 'frbioca', '1234', 3, CURRENT_TIMESTAMP);
GO
...
INSERT INTO FORNECEDOR (RAZAO_SOCIAL, NOME_FANTASIA, CNPJ, IE, LOGRADOURO, NOME_LOGRADOURO, NUM, COMPLEMENTO, BAIRRO, CIDADE, ESTADO, TELEFONE, CELULAR, EMAIL, CONTATO, DATA_INC, DATA_ALT, STATUS) VALUES ('Caterpillar', 'Caterpillar', '12.123.123/0001-11', '123.456.789.123', 'Rodovia', 'Luis de Queiroz', 0, NULL, 'Unileste', 'Piracicaba', 'SP', '(19)2106-2100', NULL, 'contato@caterpillar.com.br', 'Contato', CURRENT_TIMESTAMP, NULL, 'S')
INSERT INTO FORNECEDOR (RAZAO_SOCIAL, NOME_FANTASIA, CNPJ, IE, LOGRADOURO, NOME_LOGRADOURO, NUM, COMPLEMENTO, BAIRRO, CIDADE, ESTADO, TELEFONE, CELULAR, EMAIL, CONTATO, DATA_INC, DATA_ALT, STATUS) VALUES ('3M', '3M', '13.323.133/3301-11', '123.999.888.123', 'Rua', 'Dr Osvaldo de Oliveira', 115, NULL, 'Capão Redondo', 'São Paulo', 'SP', '(11)1898-8980', NULL, 'contato@3m.com.br', 'Contato', CURRENT_TIMESTAMP, NULL, 'S')
INSERT INTO FORNECEDOR (RAZAO_SOCIAL, NOME_FANTASIA, CNPJ, IE, LOGRADOURO, NOME_LOGRADOURO, NUM, COMPLEMENTO, BAIRRO, CIDADE, ESTADO, TELEFONE, CELULAR, EMAIL, CONTATO, DATA_INC, DATA_ALT, STATUS) VALUES ('JFN Materiais', 'JFN Materiais', '12.666.999/0001-11', '666.666.666.123', 'Rua', 'José Ferreira Neto', 0, NULL, 'Itaquera', 'São Paulo', 'SP', '(19)2106-2100', NULL, 'contato@jfnmateriais.com.br', 'Contato', CURRENT_TIMESTAMP, NULL, 'S')
